...
public class SwingUI extends JFrame {
    ...
    private Consumer<String> onCommandSubmitted; // Callback genérico para delegar el input

    public SwingUI(String titulo) {
        setTitle(titulo);
        initUI();
    }
    ...
    private void initUI() {
        ...
        // Al presionar ENTER, avisamos al listener externo
    ...
    // Configura quién va a procesar los comandos escritos
    public void setOnCommandSubmitted(Consumer<String> callback) {
        this.onCommandSubmitted = callback;
    }

    // Métodos para actualizar la pantalla desde afuera
